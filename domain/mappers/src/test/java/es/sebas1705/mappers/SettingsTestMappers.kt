...
class SettingsTestMappers {
    ...
    fun `SettingsData to SettingsModel conversion`() {
        ...
        assertEquals(settingsData.forceCompactTables, settingsModel.forceCompactTables)
    }
    ...
    fun `SettingsModel to SettingsData conversion`() {
        ...
        assertEquals(settingsModel.forceCompactTables, settingsData.forceCompactTables)
    }
}