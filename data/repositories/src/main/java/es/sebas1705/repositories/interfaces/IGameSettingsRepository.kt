...
interface IGameSettingsRepository {
    ...
    suspend fun updateMode(mode: String, impostors: Int, showImpostorsInResult: Boolean, discussionTimerSeconds: Int, impostorsKnowEachOther: Boolean, showNumOfImpostors: Boolean)
}
