...
interface ICouchbaseManager {
     ...
     *
     * @param collectionName [String] The name of the collection to count documents in.
     *
     * @return [Long] The number of documents in the collection, or -1 if an error occurs.
     *
     * @since 0.1.0
    ...
    /**
     * Counts the number of documents in a collection that match a specific parameter and values.
     *
     * @param collectionName [String] The name of the collection to count documents in.
     * @param param [String] The parameter to filter documents by.
     * @param values [Any] The values of the parameter to filter documents by.
     *
     * @return [Long] The number of documents that match the parameter and value, or -1 if an error occurs.
     *
     * @since 0.1.0
     * @author Sebas1705 12/05/2026
     */
